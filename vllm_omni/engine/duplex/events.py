...
@dataclass(frozen=True, slots=True, kw_only=True)
class ResponseTextDelta(TextDelta):
    """Compatibility text delta used by the turn-based chat fallback."""

    wire_type = "response.text.delta"


@dataclass(frozen=True, slots=True, kw_only=True)
class ResponseTextDone(TextDone):
    """Compatibility text terminal used by the turn-based chat fallback."""

    wire_type = "response.text.done"
